...
class Nodo{
	...
	public void NuevoNodo(int Valor_Numerico){
		
		if(Valor_Numerico<value) {
			if (izq == null) {
				izq = new Nodo(Valor_Numerico);
			}
				else {
					izq.NuevoNodo(Valor_Numerico);
				}
			...
			if (Valor_Numerico>value) {
				if (der == null) {
					der = new Nodo(Valor_Numerico);
				}
					else {
						der.NuevoNodo(Valor_Numerico);
					}
